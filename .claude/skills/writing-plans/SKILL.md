...
**Context:** If working in an isolated worktree, it was created by the agent-team's tournament flow (`spawn-team.sh` → `.claude/team/worktrees/`), not by a separate worktree skill.
